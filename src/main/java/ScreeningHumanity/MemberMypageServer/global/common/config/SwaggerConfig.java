...
public class SwaggerConfig {
    ...
    private Info apiInfo() {
        return new Info()
                .title("Member MyPage Service 테스트")
    ...
    private List<Server> servers() {
        ...
        dynamicServer.setUrl("https://screeninghumanity.shop/api/v1/member-mypage");
        dynamicServer.setDescription("회원의 마이페이지 중, 구독이나 즐겨찾기 등 처리용");
